...
;*************
MODSTART_POS=7		; start music at position
;*************
...
__SET_PT_VISUALS:
	...
	MOVE.W	P61_PTrig,D2	; 1Fx
	;CLR.W	$100		; DEBUG | w 0 100 2
	CMPI.W	#1,D2		; 1F1 - INVERT DIRECTION CH 3
	BNE.S	.keepDir0
	MOVE.B	SCROLL_DIR_0,D1
	NOT	D1
	MOVE.B	D1,SCROLL_DIR_0
	MOVE.W	#0,P61_PTrig	; RESET FX
	.keepDir0:
...
TIMELINE:		DC.L __BLOCK_0,__BLOCK_1,__BLOCK_1
		...
		DC.L __BLOCK_3,__BLOCK_3
		DC.L __BLOCK_4,__BLOCK_4
		DC.L __BLOCK_5,__BLOCK_5
...
Module:		INCBIN "CrippledCyborgV5.P61"; code $1009307
