...
TIMELINE:		DC.L __BLOCK_0
		...
		DC.L __BLOCK_C,__BLOCK_C,__BLOCK_C	; 42 17: KASSADRITTA2!
		DC.L __BLOCK_C,__BLOCK_C,__BLOCK_C	; 42 17: KASSADRITTA2!
		DC.L __QUIT
...
TEXT:		DC.B "WARNING!! - EPILEPSY DANGER AHEAD!!  NO, SERIOUSLY... :)  "
		...
		DC.B "IT SHOULDN'T BE NEEDED TO REMIND THAT THIS PIECE OF CRAPPY CODE IS BEST VIEWED "
		DC.B "ON A REAL AMIGA WITH A CRT DISPLAY AND BIG LOUDSPEAKERZ!! NO EMULATION FUCKERS, "
		...
		DC.B "IT'S NOW TIME FOR THE REAL TEXT: THIS TRACK WAS PUBLISHED BY MY OWN LABEL BACK "
		DC.B "IN 2000 ON KNY-04 “PEOPLEGRINDER” BUT ACCORDINGLY TO THE README INSIDE .MED FILE "
		DC.B "IT WAS COMPOSED BACK IN 1997… THIS IS NOT WHAT I REMEMBER BUT WE WRITE NOTES ON "
		DC.B "STUFF TO REMEMBER THINGS SO I ASSUME IT WAS REALLY 1997! TWENTY FUCKING THREE "
		DC.B "YEARS AGO! ALL MY AMIGA MUSIC WAS MADE ON OCTAMED SOUNDSTUDIO SO TO PUT ANY SONG "
		DC.B "INTO ASSEMBLY CODE IT REQUIRES CONVERSION TO .MOD. THIS IS USUALLY AN EASY TASK "
		DC.B "BUT BACK IN THE DAYS I THOUGHT IT WAS A GOOD IDEA TO LOAD ANY KIND OF FILES AS "
		DC.B "SAMPLES INTO OCTAMED… WELL THEY DON'T PLAY AS GOOD ON P61, SOME OF THEM MAKE "
		DC.B "GLITCHES…...I KNOW IT'S FUNNY TO SAY, GIVEN THE VISUALS :) BUT I WANTED THE INTRO TO SOUND AS CLOSE AS "
		DC.B "POSSIBLE TO THE ORIGINAL RECORDING ON VINYL SO I HAD SOME OF THIS SAMPLES RE-SAMPLED "
		DC.B "FROM-TO-AMIGA (THANKS KCMA!). TO BE HONEST ACTUALLY I STILL THINK IT WAS A GOOD "
		DC.B "IDEA…, THE SAME WAY THESE DAYS I THINK IT'S A GOOD IDEA TO FEED SEMI-RANDOM VALUES "
		DC.B "INTO BPLXMOD AMIGA REGISTERS, JUST FOR SOME EXTRA GLITCH FUN!! SO WE'VE GOT A LOT OF "
		DC.B "BLITTING ACTION HERE, IT TOOK ME A WHILE BUT I MANAGED TO DO WHAT I HAD IN MIND AND "
		DC.B "FOR THIS I MUST THANK ALL THE GUYS IN EAB DISCUSSION 'BLITTER SHIFT EATING 1PX AWAY' "
		DC.B "WHICH RAN FOR NEARLY ONE YEAR! THANKS FOR YOUR PATIENCE :) ANYWAY MY IDEA WAS TO "
		DC.B "SCROLL 4 SEPARATE BITPLANES (ONE PER AUDIO CHANNEL) BUT IT TURNS OUT THAT BLITTING "
		DC.B "SO MUCH DATA IN A SINGLE FRAME REQUIRED NASTY BLITTER BIT SET BUT I LEARNT THE HARD "
		DC.B "WAY WHAT PHOTON/SCOOPEX ONCE SAID: ‘THE BLITTER IS NASTY BUT PAULA IS NASTIER!'... "
		...
		DC.B "SCREEN TO THE GLITCHES SOON :) - MAKE SURE TO VISIT WWW.KONEY.ORG FOR MORE INDUSTRIAL "
		DC.B "AMIGACORE!! .EOF             "
	EVEN
_TEXT:
